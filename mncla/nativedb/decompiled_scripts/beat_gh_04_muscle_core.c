...
void sub_3f8(var0, var1)
{
   ...
   var5.v4.v774 = 8;
   sub_6eb(&var5);
   var5.v799 = sub_799(var831, var5.v4.v770, 1);
   ...
   sub_8ea(&var5, var831, var0, 2, 1, 13, 0);
   ...
   sub_265b(var831, 0.0f, 0, 0, 1, 1, 1);
...
int sub_799(var0, var1, var2)
{
   ...
   {
       return sub_7d7(RaceDescription_GetRaceGridType(var0), var1, var2, !RaceDescription_AllowRaceStarter(var0), 0);
   }
}

int sub_7d7(var0, var1, var2, var3, var4)
{
...
void sub_8ea(var0, var1, var2, var3, var4, var5, var6)
{
   ...
   else
   {
       if ((StatsManager_GetIntValue("tTBM", 0) == 0) && (!GetNoTutorialCommandLine()))
       {
           ...
           sub_9a2(0, 0x3f000000, 108);
           sub_a35(-1, 102, "TUTORIAL_BEAT_ME_THERE", "drv_mb_04_set", "PLAYER");
           AudioManager_SetActiveTimeSlow(0);
           sub_aea(108, 0x3f000000);
       }
       ...
       else
       {
           ...
           *((var0 + 16) + 3148) = 30000;
           ...
           while (var12 < var3)
           {
               ...
               {
                   (*((var0 + 16) + 4))[var12 * 48].v3 = sub_e12(var2);
...
int sub_a35(var0, var1, var2, var3, var4)
{
...
void sub_1533(var0, var1, var2, var3)
{
...
void sub_265b(var0, var1, var2, var3, var4, var5, var6)
{
