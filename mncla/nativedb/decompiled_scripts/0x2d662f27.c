void main()
{
   ...
   var2 = mcMissionManager_GetMission("TIMETRIAL_HOLLYWOODC");
   sub_51(var2, "SIDEKICK_TIMETRIAL_HOLLYWOODC", 0x41200000, 0);
   mcMission_ChangeState(var2, 3, 0);
   var3 = mcCareer_GetHookman(250);
   while (var3 == null)
   {
       WAITUNWARPED(500);
       var3 = mcCareer_GetHookman(250);
   }
   mcCareer_EvaluateCurrentTargetTime(0, 0, 0);
}

void sub_51(var0, var1, var2, var3)
{
