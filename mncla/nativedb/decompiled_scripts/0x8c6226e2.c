void main()
{
   ...
   var2 = mcMissionManager_GetMission("REPEAT_TOURNAMENT_HOLLYWOOD");
   sub_5f(var2, "SIDEKICK_REPEAT_TOURNAMENT_HOLLYWOOD", 0x41200000, 0);
   mcMission_ChangeState(var2, 3, 0);
}

void sub_5f(var0, var1, var2, var3)
{
