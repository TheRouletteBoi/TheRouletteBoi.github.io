void main()
{
   ...
   {
       var6 = Sidekick_AppendData(5, "SIDEKICK_TITLE_TIP", 1, 6, 10.0f, "mec_mc_01_set", "Incoming Call!", "SIDEKICK_PERFORMANCE_UNLOCK_TIP_06", "Prompt_NavigateToTutorialLog", 3, 0, "SIDEKICK_PERFORMANCE_UNLOCK_TIP_06", "mec_mc_01_set", "PLAYER");
       var7 = 0;
