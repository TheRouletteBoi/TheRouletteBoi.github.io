void main()
{
    ...
    sVar2[4] = "vp_nsn_240sx_98";
    sVar2[5] = "vp_vw_golf_83";
    sVar2[6] = "vp_mit_evo_06";
    sVar2[7] = "vp_chv_camaroSS_69";
    sVar2[8] = "vp_nsn_240sx_98";
    sVar2[9] = "vp_vw_golf_83";
    sVar2[10] = "vp_mit_evo_06";
    sVar2[11] = "vp_chv_camaroSS_69";
    sVar2[12] = "vp_nsn_240sx_98";
    sVar2[13] = "vp_vw_golf_83";
    sVar2[14] = "vp_mit_evo_06";
    sVar2[15] = "vp_chv_camaroSS_69";
    array(ref vVar19, 16);
    ...
    sub_2090( 1, 1, 1065353216, 0 );
    Game_SetCamera( ref vVar138, ref vVar141, 25.00000000, 0, 0, 0 );
    WAIT( 30000 );
    return;
}

void sub_2090(boolean bParam0, boolean bParam1, unknown uParam2, unknown uParam3)
{
    int iVar6;
    int iVar7;
    int iVar8;
