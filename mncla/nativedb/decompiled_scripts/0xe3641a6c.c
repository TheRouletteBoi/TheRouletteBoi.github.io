void main()
{
   ...
   var2 = mcMissionManager_GetMission("REPEAT_HANGOUT_WAGER_HILLS");
   sub_5d(var2, "SIDEKICK_REPEAT_HANGOUT_WAGER_HILLS", 0x41200000, 0);
   mcMission_ChangeState(var2, 3, 0);
}

void sub_5d(var0, var1, var2, var3)
{
