void main()
{
   ...
   var14.v1 = "cutscene/hangout/cut_hangout_07_ent_02";
   var14.v2 = "";
   CineScript_SetSceneName("hangout/cut_hangout_07_ent_02");
   CineScript_RequestPreraceTauntScenarioAudio("hangout/cut_hangout_07_ent_02");
   ...
   var14.v127[0 * 5].v3 = "cutscene/hangout/cut_hangout_07_ent_02/Entity/mover_drv00_car";
