           ...
           if (vhsmState_IsListener(var12) && (!Game_IsPaused()))
           {
               ...
               if ((!Game_IsPaused()) && (var14 < 20.0f))
               {
                   ...
                   else
                   {
                       ...
                       {
                           var19 = sub_67e(var20, "FIND_SH_02C_SPEND_MONEY_DESC", "FIND_SH_02C_SPEND_MONEY_TITLE", 3, 1);
                           if (var19 == 3)
                           {
                       ...
                       {
                           sub_67e(var20, "FIND_SH_02C_MONEY_RESTRICTION_DESC", "FIND_SH_02C_MONEY_RESTRICTION_TITLE", 1, 1);
                           while (var14 < 30.0f)
                           {
                               var14 = Racer_DistanceToPoint(var13, &var7);
                               WAITUNWARPED(200);
...
function sub_67e(var0, var1, var2, var3, var4)
{
