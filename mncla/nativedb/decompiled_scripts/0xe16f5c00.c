void main()
{
   ...
   L[35] = "ped_mh_001_set";
   L[36] = "pol_mc_01_set";
   Registry_SetValueInt("dt_wager_hangout1_state", 1);
   var3.v0 = 1842.443f;
   var3.v1 = -9.513f;
   var3.v2 = 617.027f;
   var6.v0 = 1836.403f;
   ...
   var24 = 2;
   var27 = 2;
   var24[0] = "SH_04_1_vp_mzd_rx8_06";
   var24[1] = "pinkslip_vp_nsn_350z_06";
   var27[0] = L[2];
   var27[1] = L[4];
   var2 = 0;
   while (var2 < 2)
   {
       var18[var2] = OpponentManager_CreateOpponent();
       OpponentManager_LoadOpponent(var18[var2], var24[var2], &(var12.v2.v0), var12.v2.v3);
       OpponentManager_AddOpponentToWorld(var18[var2]);
       var21[var2] = Opponent_GetRacer(var18[var2]);
       Racer_SetCharacterName(var21[var2], var27[var2]);
       Racer_SetStreamingLockedIn(var21[var2]);
       var2 = var2 + 1;
   }
   var30 = sub_45b(0);
   sub_4a2(var30, 0);
   ...
   var31 = START_NEW_SCRIPT_WITH_ARGS("Game/CineScripts/generated/story/cut_story_hangout_pinkslip_downtown_generated", &null, 0, 1500);
   while (!IsChildFinished(var31))
   {
       WAITUNWARPED(100);
   }
   PostProcessing_SetGameDof();
   Racer_SetStreamingLockedOut(var21[0]);
   OpponentManager_DeleteOpponent(var18[0]);
   Registry_SetValueInt("dt_wager_hangout1_state", 3);
   sub_688(var30, var18[1], var21[1], var24[1]);
   Registry_SetValueInt("dt_wager_hangout1_state", 2);
}

function sub_45b(var0)
{
   auto var3, var4;
...
void sub_688(var0, var1, var2, var3)
{
   ...
   var827 = null;
   var828 = null;
   var829 = Racer_GetCarConfig(var2);
   var830 = 0;
   var6.v4.v1[0 * 48].v0 = var0;
   var6.v4.v1[0 * 48].v2 = 0;
   var6.v4.v1[0 * 48].v5 = 1;
   var6.v4.v1[1 * 48].v1 = var1;
   var6.v4.v1[1 * 48].v0 = var2;
   var6.v4.v1[1 * 48].v2 = 2;
   var6.v4.v1[1 * 48].v5 = 1;
   var6.v4.v1[1 * 48].v4 = mcHudMapServer_CreateElement();
   mcHudMapServer_SetVehicleElement(var6.v4.v1[1 * 48].v4, 6, var2);
   mcHudMapServer_AddElement(var6.v4.v1[1 * 48].v4);
   var6.v4.v770 = 2;
   var6.v4.v771 = 0;
   var6.v4.v775 = mcCareer_GetDifficultyPlayerVsRacer(var2);
   var6.v4.v778 = 1;
   var6.v4.v780 = 0;
   var831 = LookupCity("la");
   var6.v4.v0 = CityDescription_GetRaceIndexByName(var831, "game/Race/Hollywood/Ordered/hw_ordered_jp_11");
   var832 = CityDescription_LookupRaceByIndex(var831, var6.v4.v0);
   var6.v4.v772 = RaceDescription_GetRaceType(var832);
   var6.v4.v773 = RaceDescription_GetRaceSubType(var832);
   var6.v4.v774 = 8;
   sub_98e(&var6);
   var6.v799 = sub_a3c(var832, var6.v4.v770, 1);
   ...
   sub_b97(var832, 0.0f, 0, 0, 1, 1, 1);
   var833 = HUD_GetHUDCtrl(6);
   PropertyCtrl_SetPropertyBool(var833, 0, 0);
   var825 = 0;
   var826 = RAND_INT_RANGE(400, 600);
   mcGame_ThrowEvent("missionRace");
   ...
   Race_Reset(var6.v3);
   mcCareer_AddRaceToHistory(var6.v4.v0);
   var834 = START_NEW_SCRIPT_WITH_ARGS(CityDescription_GetRaceNameByIndex(var831, var6.v4.v0), &var6, 802, 3800);
   while (!IsChildFinished(var834))
   {
       if ((((!Game_IsPaused()) && (!var825)) && (!Warper_IsWarping())) && (!CineScript_IsScenePlaying()))
       {
           var826 = var826 - 1;
           if (var826 < 0)
           {
               ...
               var828 = mcCareerSpeech_FindScenario("DAMAGE_HANGOUT_PINKSLIP_DOWNTOWN");
               if (var828 != null)
               {
                   mcCareerSpeech_PlayScenario(var828, Racer_GetVehicleDriverName(var2), "PLAYER");
               }
           }
       }
       WAITUNWARPED(10);
   }
   Race_GetRaceData(var6.v3, &(var6.v4));
   UIManager_SendEvent("calculateResults");
   var830 = 0;
   Registry_GetValueInt("raceOverTrigger", &var824);
   if (var824 == 0)
   {
       if ((!Race_IsDamagedOut(var6.v3)) && (!Race_HasBeenArrested(var6.v3)))
       {
           var830 = var6.v4.v1[0 * 48].v41 == 1;
           if (!var6.v4.v786)
           {
               mcCareer_UnlockRace(CityDescription_GetRaceNameByIndex(var831, var6.v4.v0));
               mcEvent_PostEventRaceResults("GENERIC_RACE_COMPLETE", &(var6.v4));
               mcEvent_PostEventRaceResults("RACE_EVENT", &(var6.v4));
               if (var830)
               {
                   var827 = mcRewardManager_BuildRewardCarB(var3, var3, 0, 0);
                   mcRewardManager_AddReward(var827);
                   mcEvent_PostEventStr("MISSION_EVENT", "HANGOUT_PINK_DT_OBJ_01_COMPLETE");
               }
           }
       }
       sub_1456(&var6, 0, 1, 1);
   ...
   PRINTSTRING(&var808);
   PRINTSTRING("\n");
   if ((StringCaseCompare(&var808, "returnToCruise") && var830) && (!var6.v4.v786))
   {
       var828 = mcCareerSpeech_FindScenario("REWARD_PINKSLIP_DOWNTOWN_RADIO");
       if (var828 != null)
       {
           mcCareerSpeech_PlayScenario(var828, Racer_GetVehicleDriverName(var2), "PLAYER");
       }
   }
   else if (StringCaseCompare(&var808, "restart"))
   {
       PRINTSTRING("hangout pinkslip dt restart\n");
   ...
   {
       PRINTSTRING("hangout pinkslip dt replay\n");
       Registry_SetValueInt("replaying", 1);
       sub_2445(1, 1, 0x3f800000, 0);
       Warper_Warp("REPLAY");
   ...
   Racer_HideIcon(var6.v4.v1[1 * 48].v0, 1);
   mcHudMapServer_DeleteElement(var6.v4.v1[1 * 48].v4);
   if (!var825)
   {
       sub_2bd9(var0, var6.v4.v1[1 * 48].v1, var6.v4.v1[1 * 48].v0, RAND_INT_RANGE(0, 7), Race_HasBeenArrested(var6.v3));
   }
   else
   {
...
function sub_a3c(var0, var1, var2)
{
   auto var5, var6, var7;
   ...
   {
       return sub_a7a(RaceDescription_GetRaceGridType(var0), var1, var2, !RaceDescription_AllowRaceStarter(var0), 0);
   }
}

function sub_a7a(var0, var1, var2, var3, var4)
{
...
void sub_b97(var0, var1, var2, var3, var4, var5, var6)
{
...
void sub_1456(var0, var1, var2, var3)
{
...
void sub_2445(var0, var1, var2, var3)
{
...
void sub_27dc(var0, var1, var2, var3)
{
   auto var6, var7, var8, var9, var10, var11, var12, var13;
...
void sub_2bd9(var0, var1, var2, var3, var4)
{
