void main()
{
   ...
   sub_32b5(RAND_INT_RANGE(0, 7), var4);
...
void sub_3f7(var0, var1)
{
   ...
   var5.v4.v774 = 8;
   sub_6ea(&var5);
   var5.v799 = sub_798(var831, var5.v4.v770, 1);
   ...
   sub_8e9(&var5, var831, var0, 2, 1, 13, 0);
   ...
   sub_265a(var831, 0.0f, 0, 0, 1, 1, 1);
...
int sub_798(var0, var1, var2)
{
   ...
   {
       return sub_7d6(RaceDescription_GetRaceGridType(var0), var1, var2, !RaceDescription_AllowRaceStarter(var0), 0);
   }
}

int sub_7d6(var0, var1, var2, var3, var4)
{
...
void sub_8e9(var0, var1, var2, var3, var4, var5, var6)
{
   ...
   else
   {
       if ((StatsManager_GetIntValue("tTBM", 0) == 0) && (!GetNoTutorialCommandLine()))
       {
           ...
           sub_9a1(0, 0x3f000000, 108);
           sub_a34(-1, 102, "TUTORIAL_BEAT_ME_THERE", "drv_mb_04_set", "PLAYER");
       ...
       else
       {
           ...
           *((var0 + 16) + 3148) = 30000;
           ...
           while (var12 < var3)
           {
               ...
               {
                   (*((var0 + 16) + 4))[var12 * 48].v3 = sub_e11(var2);
...
int sub_a34(var0, var1, var2, var3, var4)
{
...
void sub_1532(var0, var1, var2, var3)
{
...
void sub_265a(var0, var1, var2, var3, var4, var5, var6)
{
