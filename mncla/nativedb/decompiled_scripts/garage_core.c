void main()
{
   auto var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13, var14, var15, var16, var17, var18, var19, var20, var21, var22, var23, var24, var25, var26, var27, var28, var29;
   ...
   var22 = 0;
   var23 = -1;
   var24 = UIManager_GetState("Cruising_Offline");
   var25 = UIManager_GetState("GPSScene");
   if (L[0].v1.v1 == 506)
   {
       var19 = 1;
   }
   ...
   while (!var13)
   {
       ...
       if (vhsmState_IsListener(var24))
       {
           ...
           else if ((((PoliceManager_CheckPoliceActivity(1) > 1) || var19) || Net_IsConnecting()) || Net_IsNetworked())
           {
               WAITUNWARPED(100);
           }
           else
           ...
           if (var10 == 5)
           {
               ...
               sub_a39(L[0].v1.v29, &var14, &(L[0].v1.v30), &(L[0].v1.v34), &(L[0].v1.v44));
               if (var20)
               {
                   var20 = 0;
               ...
               while (var11 == 0)
               {
                   ...
                   if (var12 == 1)
                   {
                       ...
                       {
                           sub_133f(L[0].v0, L[0].v1, L[0].v2, L[0].v3, L[0].v4, L[0].v5, L[0].v6, L[0].v7, L[0].v8, L[0].v9, L[0].v10, L[0].v11, L[0].v12, L[0].v13, L[0].v14, L[0].v15, L[0].v16, L[0].v17, L[0].v18, L[0].v19, L[0].v20, L[0].v21, L[0].v22, L[0].v23, L[0].v24, L[0].v25, L[0].v26, L[0].v27, L[0].v28, L[0].v29, L[0].v30, L[0].v31, L[0].v32, L[0].v33, L[0].v34, L[0].v35, L[0].v36, L[0].v37, L[0].v38, L[0].v39, L[0].v40, L[0].v41, L[0].v42, L[0].v43, L[0].v44, L[0].v45, L[0].v46, L[0].v47, L[0].v48);
                           mcHudMapServer_RemoveElement(L[0].v1.v2);
                       }
                   }
                   else
                   ...
                   if (var11 < 1)
                   {
                       ...
                       if (!GetNoTutorialCommandLine())
                       {
                           if (Racer_IsMotorcycle(var5) && (StatsManager_GetIntValue("tTMO", 0) == 0))
                           {
                               ...
                               sub_154b(0, 0x3f000000, 108);
                               sub_15e2(-1, 88, "TUTORIAL_MOTORCYCLE_INGAME", "drv_mb_04_set", "PLAYER");
                               AudioManager_SetActiveTimeSlow(0);
                               sub_1697(108, 0x3f000000);
                           }
                           while (vhsmState_IsActive(var25) || FlashNavigator_IsTransitioning())
                           {
                               Registry_GetValueInt("NET_UNLOADCAREER", &var11);
                               if (var11 > 0)
                               {
                           ...
                           var23 = Racer_GetActiveAbility(var5);
                           if ((var23 == 0) && (StatsManager_GetIntValue("tTZO", 0) == 0))
                           {
                               StatsManager_UpdateStatInt("tTZO", 0, 3, 1);
                               AudioManager_SetActiveTimeSlow(1);
                               sub_154b(0, 0x3f000000, 108);
                               sub_15e2(-1, 90, "TUTORIAL_ZONE_INGAME", "drv_mb_04_set", "PLAYER");
                               AudioManager_SetActiveTimeSlow(0);
                               sub_1697(108, 0x3f000000);
                           }
                           else if ((var23 == 1) && (StatsManager_GetIntValue("tTAG", 0) == 0))
                           {
                               StatsManager_UpdateStatInt("tTAG", 0, 3, 1);
                               AudioManager_SetActiveTimeSlow(1);
                               sub_154b(0, 0x3f000000, 108);
                               sub_15e2(-1, 91, "TUTORIAL_AGRO_INGAME", "drv_mb_04_set", "PLAYER");
                               AudioManager_SetActiveTimeSlow(0);
                               sub_1697(108, 0x3f000000);
                           }
                           else if ((var23 == 2) && (StatsManager_GetIntValue("tTRO", 0) == 0))
                           {
                               StatsManager_UpdateStatInt("tTRO", 0, 3, 1);
                               AudioManager_SetActiveTimeSlow(1);
                               sub_154b(0, 0x3f000000, 108);
                               sub_15e2(-1, 92, "TUTORIAL_ROAR_INGAME", "drv_mb_04_set", "PLAYER");
                               AudioManager_SetActiveTimeSlow(0);
                               sub_1697(108, 0x3f000000);
                           }
                           else if ((var23 == 3) && (StatsManager_GetIntValue("tTEM", 0) == 0))
                           {
                               StatsManager_UpdateStatInt("tTEM", 0, 3, 1);
                               AudioManager_SetActiveTimeSlow(1);
                               sub_154b(0, 0x3f000000, 108);
                               sub_15e2(-1, 93, "TUTORIAL_EMP_INGAME", "drv_mb_04_set", "PLAYER");
                               AudioManager_SetActiveTimeSlow(0);
                               sub_1697(108, 0x3f000000);
                           }
                       }
...
void sub_609(var0, var1, var2, var3)
{
...
void sub_a39(var0, var1, var2, var3, var4)
{
...
void sub_bc2(var0, var1, var2, var3)
{
   auto var6, var7, var8, var9, var10, var11, var12, var13;
...
void sub_f04(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13, var14, var15, var16, var17, var18, var19, var20, var21, var22, var23, var24, var25, var26, var27, var28, var29, var30, var31, var32, var33, var34, var35, var36, var37, var38, var39, var40, var41, var42, var43, var44, var45, var46, var47, var48)
{
...
void sub_133f(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13, var14, var15, var16, var17, var18, var19, var20, var21, var22, var23, var24, var25, var26, var27, var28, var29, var30, var31, var32, var33, var34, var35, var36, var37, var38, var39, var40, var41, var42, var43, var44, var45, var46, var47, var48)
{
...
function sub_15e2(var0, var1, var2, var3, var4)
{
