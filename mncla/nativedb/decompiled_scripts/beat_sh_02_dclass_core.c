void main()
{
   ...
   sub_3d1f(RAND_INT_RANGE(0, 7), var10);
...
void sub_3c2(var0, var1, var2)
{
   ...
   sub_71b(&var6, var837, var0, 2, 1, 13, "GREET_BEAT_SH_02_DCLASS");
   ...
   sub_24e6(&var6);
   var6.v799 = sub_2594(var837, var6.v4.v770, 1);
   ...
   sub_27ac(var837, 0.0f, 0, 0, 1, 1, 1);
   while (var824 == 0)
   {
       ...
       sub_1364(&var6, 0, 1, 1);
       if ((var6.v4.v1[0 * 48].v41 == 1) && (!var6.v4.v786))
       {
           UILogic_ResumeGame();
           sub_313b(1, 1, 0x3f800000, 0);
           sub_3471(&var6);
...
void sub_71b(var0, var1, var2, var3, var4, var5, var6)
{
   ...
   else
   {
       if ((StatsManager_GetIntValue("tTBM", 0) == 0) && (!GetNoTutorialCommandLine()))
       {
           ...
           sub_7d3(0, 0x3f000000, 108);
           sub_866(-1, 102, "TUTORIAL_BEAT_ME_THERE", "drv_mb_04_set", "PLAYER");
           AudioManager_SetActiveTimeSlow(0);
           sub_91b(108, 0x3f000000);
       }
       ...
       else
       {
           ...
           *((var0 + 16) + 3148) = 30000;
           ...
           while (var12 < var3)
           {
               ...
               {
                   (*((var0 + 16) + 4))[var12 * 48].v3 = sub_c43(var2);
...
int sub_866(var0, var1, var2, var3, var4)
{
...
void sub_1364(var0, var1, var2, var3)
{
...
int sub_2594(var0, var1, var2)
{
   ...
   {
       return sub_25d2(RaceDescription_GetRaceGridType(var0), var1, var2, !RaceDescription_AllowRaceStarter(var0), 0);
   }
}

int sub_25d2(var0, var1, var2, var3, var4)
{
...
void sub_27ac(var0, var1, var2, var3, var4, var5, var6)
{
...
void sub_313b(var0, var1, var2, var3)
{
