...
void sub_71b(var0, var1, var2)
{
   auto var5, var6, var7, var8;

   sub_72f(var1, var2, *(var0 + 3116));
   var5 = 0;
   while (var5 < *(var0 + 3080))
   {
       sub_7e4(&((*(var0 + 4))[var5 * 48]), var5, 0, var1, *(var0 + 3116));
       var5 = var5 + 1;
   }
}

void sub_72f(var0, var1, var2)
{
   auto var5, var6, var7, var8;
...
void sub_7e4(var0, var1, var2, var3, var4)
{
       ...
       else
       {
           ...
           if (var10)
           {
               ...
               if (var23)
               {
                   if (var8 == -1)
                   {
                       sub_198e(var0, &var8, var14, var35);
                   }
                   if (((var8 > 0) && (Race_GetTimerHuman(*(var0 + 12)) > var8)) && (var18 == -1))
                   {
                       var18 = sub_1bb4(var0, var14 + var35);
                   }
               }
               if (*((var0 + 16) + 3120))
               {
               ...
               if (Racer_IsActive((*((var0 + 16) + 4))[var17 * 48].v0))
               {
                   ...
                   if (var25 || (var12 && mcCareer_ShouldAutoWin()))
                   {
                       ...
                       if ((*((var0 + 16) + 4))[var17 * 48].v6 == var1)
                       {
                           ...
                           else
                           {
                               ...
                               if (var12)
                               {
                                   ...
                                   PRINTSTRING("\n");
                                   sub_72f(var1, var2, *((var0 + 16) + 3116) - (*((var0 + 16) + 4))[var17 * 48].v7);
                                   AudioManager_PlayFrontendSound("HUD_CHECKPOINT_MASTER");
                               }
                               (*((var0 + 16) + 4))[var17 * 48].v6 = 0;
                               sub_7e4(&((*((var0 + 16) + 4))[var17 * 48]), var17, 0, var1, *((var0 + 16) + 3116));
                       ...
                       else
                       {
                           ...
                           sub_7e4(&((*((var0 + 16) + 4))[var17 * 48]), var17, var33, var1, *((var0 + 16) + 3116));
                           if (var12)
                           {
                               if (var33 < (var1 - 1))
                               {
...
void sub_198e(var0, var1, var2, var3)
{
...
void sub_1e74(var0, var1, var2, var3)
{
   ...
   if (*((var0 + 16) + 3120) && (var8 == 0))
   {
       ...
       (*((var0 + 16) + 4))[var1 * 48].v41 = sub_1ed8(var0, var1, var7);
...
function sub_1ed8(var0, var1, var2)
{
