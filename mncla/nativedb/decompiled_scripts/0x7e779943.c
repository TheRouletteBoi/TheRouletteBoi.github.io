void main()
{
   ...
   var14.v1 = "cutscene/hangout/cut_hangout_06_ext";
   var14.v2 = "";
   CineScript_SetSceneName("hangout/cut_hangout_06_ext");
   CineScript_RequestPreraceTauntScenarioAudio("hangout/cut_hangout_06_ext");
   ...
   if (var344 != null)
   {
       ...
       var14.v127[0 * 5].v3 = "cutscene/hangout/cut_hangout_06_ext/Entity/mover_drv00_car";
       var3[0] = Racer_GetStreamLockState(var344);
       Racer_SetStreamingLockedIn(var344);
   }
   var14.v126 = 1;
   var14.v179[0 * 7].v0 = "menu_to_cam";
   var14.v179[0 * 7].v1 = 0;
   var14.v179[0 * 7].v2 = "";
   var14.v179[0 * 7].v3 = -1;
   ...
   var14.v179[1 * 7].v0 = "speechsystem_play";
   var14.v179[1 * 7].v1 = 0;
   var14.v179[1 * 7].v2 = "";
   var14.v179[1 * 7].v3 = -1;
   var14.v179[1 * 7].v4 = 1.6f;
   var14.v179[1 * 7].v5 = 0.0f;
   var14.v179[1 * 7].v6 = 0.0f;
   var14.v179[2 * 7].v0 = "cut_to_game";
   var14.v179[2 * 7].v1 = 0;
   var14.v179[2 * 7].v2 = "";
   var14.v179[2 * 7].v3 = -1;
   var14.v179[2 * 7].v4 = 3.333333f;
