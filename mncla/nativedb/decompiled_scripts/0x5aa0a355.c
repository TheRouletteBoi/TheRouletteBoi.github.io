void main()
{
   ...
   var14.v1 = "cutscene/hangout/cut_hangout_06_ent_01";
   var14.v2 = "";
   CineScript_SetSceneName("hangout/cut_hangout_06_ent_01");
   CineScript_RequestPreraceTauntScenarioAudio("hangout/cut_hangout_06_ent_01");
   CineScript_UseRacerNativeCharacter(0);
   var14.v321 = 1;
   var14.v322 = 0;
   var14.v323 = 0;
   CineScript_Characters_AssignNameToSlot("ped_fa_002_set", 0);
   var14.v5[0 * 6].v0 = CineScript_Characters_ReadSlotPath(0);
   var14.v5[0 * 6].v1 = CineScript_Characters_ReadSlotName(0);
   var14.v5[0 * 6].v2 = "cutscene/hangout/cut_hangout_06_ent_01/Entity/fwalk_ped00_name_ped_fa_002_set";
   var14.v5[0 * 6].v3 = "fwalk_ped00_name_ped_fa_002_set";
   var14.v5[0 * 6].v5 = -1;
   ...
   var14.v5[1 * 6].v2 = "cutscene/hangout/cut_hangout_06_ent_01/Entity/mwalk_ped01_name_ped_mb_004_set";
   var14.v5[1 * 6].v3 = "mwalk_ped01_name_ped_mb_004_set";
   var14.v5[1 * 6].v5 = -1;
   var14.v4 = 2;
   ...
   if (var344 != null)
   {
       ...
       var14.v127[0 * 5].v3 = "cutscene/hangout/cut_hangout_06_ent_01/Entity/mover_drv00_car";
       var3[0] = Racer_GetStreamLockState(var344);
       Racer_SetStreamingLockedIn(var344);
   }
   var14.v126 = 1;
   var14.v179[0 * 7].v0 = "cam_to_menu";
   var14.v179[0 * 7].v1 = 0;
   var14.v179[0 * 7].v2 = "";
   var14.v179[0 * 7].v3 = -1;
