...
void sub_1293()
{
   ...
   if (!var3)
   {
       if (!Warper_IsReadyToLoadStuff())
       {
           PRINTSTRING("WarpDown: Waiting for previous warp to complete\n");
           while (!Warper_IsReadyToLoadStuff())
           {
               WAITUNWARPED(100);
               PRINTSTRING("WarpDown: Waiting for previous warp\n");
           }
           PRINTSTRING("WarpDown: Previous Warp is complete\n");
       }
       PRINTSTRING("WarpDown! USER_WAIT_NO_CUT_DOWN\n");
       Warper_Warp("USER_WAIT_NO_CUT_DOWN");
   }
}

void sub_13e4(var0, var1)
{
   auto var4, var5, var6;
...
void sub_17cd(var0)
{
   ...
   sub_181e(var0, 0, &var3);
   PRINTSTRING("[ctfscript] SetupFreeForAll done...\n");
}

void sub_181e(var0, var1, var2)
{
       ...
       else
       {
           ...
           while (var6 < *((var1 + 16) + 3080))
           {
               ...
               if (var10 != null)
               {
                   ...
                   if (var12)
                   {
                       sub_34e6(var0, &((*((var1 + 16) + 4))[var6 * 48]));
                       sub_3616(var0, &((*((var1 + 16) + 4))[var6 * 48]));
                       if ((*((var1 + 16) + 4))[var6 * 48].v2 == 0)
                       {
                           sub_b82(var0, var1 + 16, &((*((var1 + 16) + 4))[var6 * 48]), 0);
                       }
                   }
                   sub_36ee(var0, &((*((var1 + 16) + 4))[var6 * 48]));
               }
               var6 = var6 + 1;
           }
           sub_38e7(var1 + 16);
           if (sub_3dc1(var0, var1))
           {
               var9 = 1;
               sub_4523(var1 + 16);
           }
...
void sub_1edd(var0, var1)
{
   ...
   {
       var62 = sub_1fa2(var4.v2, var1);
       var63 = sub_1fa2(var4.v3, var1);
       var64 = 0;
       if (var4.v2 != null)
       {
       ...
       if (var4.v0 == 1)
       {
           ...
           SplashManager_Splash(0, var9, "CTF_FLAG_RESET", 0.5f, 1, sub_209d(var4.v1));
       }
       else if (var4.v0 == 2)
       {
       ...
       else if (var4.v0 == 3)
       {
           ...
           {
               SplashManager_Splash(0, var9, "CTF_SPLASH_FLAG_TAKEN", 0.5f, 1, sub_209d(var64));
           }
       }
       else if (var4.v0 == 4)
       {
           ...
           if ((!var11) || Racer_IsLocalPlayer(var4.v2))
           {
               sub_25a3(var4.v2, "CTF_SPLASH_RACERA_NAME");
               SplashManager_Splash(0, var9, "CTF_SPLASH_FLAG_DELIVERED", 0.5f, 1, sub_209d(var64));
           }
       ...
       else if (var4.v0 == 5)
       {
           ...
           if (var4.v1 == 2)
           {
               SplashManager_Splash(0, var9, "CTF_SPLASH_SAVED_FLAG_RED", 0.5f, 1, sub_209d(var64));
           }
           else if (var4.v1 == 1)
           {
               SplashManager_Splash(0, var9, "CTF_SPLASH_SAVED_FLAG_BLUE", 0.5f, 1, sub_209d(var64));
           }
       ...
       else if (var4.v0 == 6)
       {
           ...
           if ((!var11) || Racer_IsLocalPlayer(var4.v2))
           {
               SplashManager_Splash(0, var9, "CTF_SPLASH_FLAG_DROPPED", 0.5f, 1, sub_209d(var64));
           }
       }
       else if (var4.v0 == 8)
       {
...
function sub_3dc1(var0, var1)
{
   ...
   {
       return sub_3fa8(var0, var1);
   }
   else if ((var4 == 8) || (var4 == 11))
   {
       return sub_4216(var1);
   }
   else if (var4 == 13)
   {
       return sub_43f3(var1);
   }
   else
   {
