...
void sub_353(var0, var1, var2)
{
   ...
   while (!Race_IsFinished(*(var0 + 12)))
   {
       ...
       else if (var13 == 1)
       {
           ...
           if (*((var0 + 16) + 3100) == 0)
           {
               var9 = (GetOpponentDamageCommandLine() * 1) / 2;
           }
           else if (*((var0 + 16) + 3100) == 1)
           {
               var9 = (GetOpponentDamageCommandLine() * 3) / 4;
           }
           else if (*((var0 + 16) + 3100) == 2)
           {
               var9 = GetOpponentDamageCommandLine() * 1;
           }
...
void sub_15ca(var0, var1, var2, var3)
{
