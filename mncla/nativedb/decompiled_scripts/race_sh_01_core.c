void main()
{
           ...
           if (vhsmState_IsListener(var32) && (!Game_IsPaused()))
           {
               ...
               if ((!Game_IsPaused()) && (var24 < 30.0f))
               {
                   ...
                   else
                   {
                       ...
                       mcHudMapServer_RemoveElement(var6);
                       mcHudMapServer_AddElement(L[0].v0.v97.v2);
                       sub_830(var7, var18, var19, var22, var28, L[0].v0.v97.v2);
   ...
   sub_27a8(RAND_INT_RANGE(0, 7), var31);
...
void sub_830(var0, var1, var2, var3, var4, var5)
{
...
function sub_b95(var0, var1, var2)
{
   auto var5, var6, var7;
   ...
   {
       return sub_bd3(RaceDescription_GetRaceGridType(var0), var1, var2, !RaceDescription_AllowRaceStarter(var0), 0);
   }
}

function sub_bd3(var0, var1, var2, var3, var4)
{
...
void sub_ccc(var0, var1, var2, var3, var4, var5, var6)
{
...
void sub_164b(var0, var1, var2, var3)
{
