void main()
{
   ...
   sub_3e38(RAND_INT_RANGE(0, 15), var10);
...
int sub_435(var0, var1, var2, var3, var4)
{
...
void sub_4f5(var0, var1, var2)
{
   ...
   sub_7d5(&var6, var830, var0, 2, 1, 13, "GREET_BEAT_SH_04_BCLASS");
   ...
   sub_2597(&var6);
   var6.v799 = sub_2645(var830, var6.v4.v770, 1);
   ...
   sub_285d(var830, 0.0f, 0, 0, 1, 1, 1);
   while (var824 == 0)
   {
...
void sub_7d5(var0, var1, var2, var3, var4, var5, var6)
{
   ...
   else
   {
       if ((StatsManager_GetIntValue("tTBM", 0) == 0) && (!GetNoTutorialCommandLine()))
       {
           ...
           sub_88d(0, 0x3f000000, 108);
           sub_920(-1, 102, "TUTORIAL_BEAT_ME_THERE", "drv_mb_04_set", "PLAYER");
           AudioManager_SetActiveTimeSlow(0);
           sub_9d5(108, 0x3f000000);
       }
       ...
       else
       {
           ...
           *((var0 + 16) + 3148) = 30000;
           ...
           while (var12 < var3)
           {
               ...
               {
                   (*((var0 + 16) + 4))[var12 * 48].v3 = sub_cfd(var2);
...
int sub_920(var0, var1, var2, var3, var4)
{
...
void sub_141e(var0, var1, var2, var3)
{
...
int sub_2645(var0, var1, var2)
{
   ...
   {
       return sub_2683(RaceDescription_GetRaceGridType(var0), var1, var2, !RaceDescription_AllowRaceStarter(var0), 0);
   }
}

int sub_2683(var0, var1, var2, var3, var4)
{
...
void sub_285d(var0, var1, var2, var3, var4, var5, var6)
{
...
void sub_3462(var0, var1, var2, var3)
{
...
void sub_37f9(var0, var1, var2, var3)
{
   auto var6, var7, var8, var9, var10, var11, var12, var13;
