void main()
{
    ...
    sVar2[3] = "vp_chv_police_96";
    sVar2[4] = "vp_chv_police_96";
    sVar2[5] = "vp_chv_police_96";
    sVar2[6] = "vp_chv_police_96";
    sVar2[7] = "vp_chv_police_96";
    sVar2[8] = "vp_chv_police_96";
    sVar2[9] = "vp_chv_police_96";
    sVar2[10] = "vp_chv_police_96";
    sVar2[11] = "vp_chv_police_96";
    sVar2[12] = "vp_chv_police_96";
    sVar2[13] = "vp_chv_police_96";
    sVar2[14] = "vp_chv_police_96";
    sVar2[15] = "vp_chv_police_96";
    array(ref vVar19, 16);
    ...
    for ( I = 0; I < 16; I++ )
    {
        if (I > 0)
        {
            ...
            LayerPlayer_LoadPlayer( I, uVar119[I], ref vVar19[I], fVar68[I] );
        }
    ...
    sub_2110( 1, 1, 1065353216, 0 );
    Game_SetCamera( ref vVar138, ref vVar141, 25.00000000, 0, 0, 0 );
    WAIT( 30000 );
    return;
}

void sub_2110(boolean bParam0, boolean bParam1, unknown uParam2, unknown uParam3)
{
    int iVar6;
    int iVar7;
    int iVar8;
