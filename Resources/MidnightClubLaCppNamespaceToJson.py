...
namespace SYSTEM
{
	...
	static void PRINTSTRING(std::string str) { invoke<Void>(0xECF8EB5F, str); }
	...
	static int START_NEW_SCRIPT(std::string ScriptName, int StackSize) { return invoke<int>(0x3F166D0E, ScriptName, StackSize); }
	static int START_NEW_SCRIPT_WITH_ARGS(std::string ScriptName, Any* Args, int Count, int Stacksize) { return invoke<int>(0x4A2100E4, ScriptName, Args, Count, Stacksize); }
	...
	static void CLEAR_TEXT_LABEL(std::string Textlabel) { invoke<Void>(0xA66AAE8F, Textlabel); }
	...
	static BOOL StringCompare(std::string str1, std::string str2) { return invoke<BOOL>(0xCF05DDAF, str1, str2); }
	static BOOL StringCaseCompare(std::string str1, std::string str2) { return invoke<BOOL>(0x12BB5DA8, str1, str2); }
	static BOOL StringCaseContains(std::string str1, std::string str2) { return invoke<BOOL>(0x3820B540, str1, str2); }
	static void StringCat(std::string str1, std::string str2) { invoke<Void>(0x20FE66C8, str1, str2); }
...
{
	static Vehicle LocalOptions_LookupVehicleProfile(std::string p0) { return invoke<Vehicle>(0x470CA20A, p0); }
	...
	static int LocalOptions_LookupGarageCar(std::string p0) { return invoke<int>(0xCB3A9615, p0); }
...
namespace CarConfig
{
	static std::string CarConfig_GetVehicleTypeName(int p0) { return invoke<std::string>(0x2EE52E35, p0); }
}
...
namespace Lookup
{
	static std::string GetCurrentCity() { return invoke<std::string>(0xC6FACDFF); }
	static int LookupCity(std::string p0) { return invoke<int>(0x3551249C, p0); }
	static int LookupCar(std::string p0) { return invoke<int>(0x5397AD5F, p0); }
	static std::string LookupCarName(std::string p0) { return invoke<std::string>(0x2386A437, p0); }
}
...
namespace CityDescription
{
	...
	static int CityDescription_LookupRace(int p0, std::string p1) { return invoke<int>(0x728FD6C4, p0, p1); }
	...
	static int CityDescription_GetRaceIndexByName(int p0, std::string p1) { return invoke<int>(0x3F4D6F71, p0, p1); }
	static std::string CityDescription_GetRaceNameByIndex(int p0, int p1) { return invoke<std::string>(0x1F1D003C, p0, p1); }
}
...
namespace RaceDescription
{
	...
	static std::string RaceDescription_GetCarConfigName(Race p0) { return invoke<std::string>(0xE2963CD8, p0); }
	static std::string RaceDescription_GetEasyRaceName(Race p0) { return invoke<std::string>(0x94EE2327, p0); }
...
namespace mcRace
{
	...
	static void mcRaceArray_AddRace(mcArray* array, std::string race, int index) { invoke<Void>(0x52216FE6, array, race, index); }
}

namespace Commands
{
	static std::string GetCityCommandLine(int* p0) { return invoke<std::string>(0xBF7051E6, p0); }
	static std::string GetCarCommandLine(int* p0) { return invoke<std::string>(0x0241D89D, p0); }
	static std::string GetExtraCarCommandLine(int* p0) { return invoke<std::string>(0x0E041333, p0); }
	static Byte GetNoScriptsCommandLine() { return invoke<Byte>(0xCAAEE6F8); }
	static std::string GetScriptCommandLine(int* p0) { return invoke<std::string>(0x81C42955, p0); }
	static std::string GetRaceNameCommandLine(int* p0) { return invoke<std::string>(0x4F32D9CB, p0); }
...
namespace mcGame
{
	static void mcGame_ThrowEvent(std::string p0) { invoke<Void>(0xD4E9439E, p0); }
}
...
namespace GRAPHICS
{
	...
	static void Graphics_GetCopTimeString(std::string p0) { invoke<Void>(0x4BB649E0, p0); }
...
namespace AUDIO_MANAGER
{
	...
	static void AudioManager_PlayFrontendSound(std::string sound) { invoke<Void>(0x41D3B1BC, sound); }
	static void AudioManager_EnterHangoutState(std::string p0) { invoke<Void>(0x98FBFCF0, p0); }
	static void AudioManager_ExitHangoutState() { invoke<Void>(0xB29D11C7); }
	static void AudioManager_InitHangout(std::string p0, std::string p1, Vector3* p2) { invoke<Void>(0x934A5AE7, p0, p1, p2); }
	static void AudioManager_DestroyHangout(std::string p0) { invoke<Void>(0xA56F22CF, p0); }
	static void AudioManager_SuspendHangout(std::string p0, BOOL p1) { invoke <Void>(0x9C4954D6, p0, p1); }
...
namespace MC_EVENT
{
	static void mcEvent_PostEventStr(std::string p0, std::string value) { invoke<Void>(0xF0FB95EA, p0, value); }
	static void mcEvent_PostEventInt(std::string p0, int value) { invoke<Void>(0xADEFAE9E, p0, value); }
	static void mcEvent_PostEventFloat(std::string p0, float value) { invoke<Void>(0x9F6356BA, p0, value); }
	static void mcEvent_PostEventRaceResults(std::string p0, int p1) { invoke<Void>(0x68501B53, p0, p1); }
	static void mcEvent_PostEventRaceAbort(std::string p0, std::string p1) { invoke<Void>(0x87DB783D, p0, p1); }
}
...
namespace OPPONENT_MANAGER
{
	...
	static int OpponentManager_FindRandomAvailableCharacterByVehicleName(std::string vehicle) { return invoke<int>(0x624115E9, vehicle); }
...
namespace RACER
{
	...
	static std::string Racer_GetName(Race p0) { return invoke<std::string>(0xA737601B, p0); }
	static std::string Racer_GetVehicleDriverName(Race p0) { return invoke<std::string>(0x06C120F0, p0); }
	static void Racer_SetUIDAndCharacterName(Race p0, int p1, std::string p2) { invoke<Void>(0x5B10D7E2, p0, p1, p2); }
	static void Racer_SetCharacterName(Race p0, std::string p1) { invoke<Void>(0x43F0A63A, p0, p1); }
...
{
	static BOOL FlashHelper_GetGlobalString(int p0, std::string global, std::string value) { return invoke<BOOL>(0x1B384283, p0, global, value); }
	static BOOL FlashHelper_GetGlobalInt(int p0, std::string global, int* value) { return invoke<BOOL>(0x422DF6CB, p0, global, value); }
	static void FlashHelper_SetGlobalString(int p0, std::string global, std::string value) { invoke<Void>(0x2BC78B6A, p0, global, value); }
	static void FlashHelper_SetGlobalInt(int p0, std::string global, int value) { invoke<Void>(0x65552629, p0, global, value); }
	static void FlashHelper_SetGlobalStringArray(int p0, int p1, int p2, int p3) { invoke<Void>(0xA61D2611, p0, p1, p2, p3); }
	static void FlashHelper_SetGlobalIntArray(int p0, std::string p1, int p2, int p3) { invoke<Void>(0xA48DACD5, p0, p1, p2, p3); }
	static void FlashHelper_SetMovieEnabled(int p0, BOOL p1) { invoke<Void>(0xCA47ABA6, p0, p1); }
	static void FlashHelper_SetGlobalFloat(int p0, std::string global, float value) { invoke<Void>(0x02E89308, p0, global, value); }
...
namespace UI_MANAGER
{
	...
	static int UIManager_FindMovie(std::string Movie) { return invoke<int>(0x6CE6702A, Movie); }
	...
	static std::string UIManager_GetStringBuf(int p0) { return invoke<std::string>(0xF4C93E71, p0); }
	static void UIManager_AddRaceResult(int p0, int p1, int p2, int p3) { invoke<Void>(0x1855A902, p0, p1, p2, p3); }
	static void UIManager_SendEvent(std::string Event) { invoke<Void>(0x0FFFD1AE, Event); }
	...
	static int UIManager_GetState(std::string State) { return invoke<int>(0x808BA9FA, State); }
	...
	static void UIManager_SetStateDataString(int p0, int p1, std::string value) { invoke<Void>(0x4C534259, p0, p1, value); }
	...
	static void UIManager_QueueDisplay(std::string p0, float p1) { invoke<Void>(0xCB33B124, p0, p1); }
...
{
	static void SplashManager_Splash(int p0, int p1, std::string p2, float p3, BOOL p4, int p5) { invoke<Void>(0xCD526461, p0, p1, p2, p3, p4, p5); }
...
namespace REGISTRY
{
	static void Registry_SetValueFloat(std::string registry, float value) { invoke<Void>(0x3518B4EA, registry, value); }
	static void Registry_SetValueInt(std::string registry, int value) { invoke<Void>(0x1623E188, registry, value); }
	static void Registry_SetValueString(std::string registry, std::string value) { invoke<Void>(0x3F064E6C, registry, value); }
	static void Registry_SetValueBool(std::string registry, BOOL value) { invoke<Void>(0x2CE7DA55, registry, value); }
	static void Registry_GetValueFloat(std::string registry, float* value) { invoke<Void>(0x257CF32F, registry, value); }
	static void Registry_GetValueInt(std::string registry, int* value) { invoke<Void>(0x2CA24DB0, registry, value); }
	static void Registry_GetValueString(std::string registry, std::string value) { invoke<Void>(0xE79929B4, registry, value); }
	static std::string Registry_GetValueConstString(std::string registry) { return invoke<std::string>(0x7019657F, registry); }
	static BOOL Registry_GetValueBool(std::string registry) { return invoke<BOOL>(0xCE7B5628, registry); }
}
...
namespace UI_LOGIC
{
	...
	static void Ctrl_SetText(int p0, std::string text) { invoke<Void>(0x080DEEFD, p0, text); }
	...
	static void Form_SetText(int p0, std::string text) { invoke<Void>(0xDE4F6972, p0, text); }
	static void Form_SetTextRaw(int p0, std::string text) { invoke<Void>(0xB6A6A906, p0, text); }
	...
	static void SimpleListForm_SetListText(int p0, int p1, int p2, std::string text) { invoke<Void>(0xAB801023, p0, p1, p2, text); }
	...
	static void PerspectiveForm_SetDescription(int p0, std::string p1) { invoke<Void>(0x5A95635A, p0, p1); }
	static void PerspectiveForm_SetDescriptionRaw(int p0, std::string p1) { invoke<Void>(0xED11E3B5, p0, p1); }
	...
	static void Warper_Warp(std::string p0) { invoke<Void>(0xBBED1C6F, p0); }
	...
	static void PropertyCtrl_SetPropertyString(int p0, int p1, std::string value) { invoke<Void>(0x0F1999BA, p0, p1, value); }
	static void PropertyCtrl_GetPropertyString(int p0, int p1, std::string value) { invoke<Void>(0xEF5CAE78, p0, p1, value); }
	static void Sidekick_Interrupt() { invoke<Void>(0x168D5EE7); }
	static void Sidekick_Clean(BOOL clean) { invoke<Void>(0x8B9F7B5F, clean); }
	static void Sidekick_AppendData(int p0, int p1, int p2, int p3, float p4, std::string p5, int p6, std::string p7, int p8, int p9, BOOL p10, int p11, std::string p12, std::string p13) { invoke<Void>(0xBCF67199, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13); }
...
{
	static void StringTable_SetString(int p0, std::string value) { invoke<Void>(0x521FA0D7, p0, value); }
	static void StringTable_SetInt(int p0, int value) { invoke<Void>(0x873C5B6C, p0, value); }
	static std::string StringTable_GetString(int p0) { return invoke<std::string>(0x8841214B, p0); }
}
...
namespace CINE_SCRIPT
{
	...
	static void CineScript_SetSceneName(std::string name) { invoke<Void>(0x7ACED201, name); }
	static std::string CineScript_GetSceneName() { return invoke<std::string>(0xFBE4887B); }
	...
	static BOOL CineScript_Prop_LoadSetDressing(std::string p0, BOOL p1) { return invoke<BOOL>(0xA3442E17, p0, p1); }
...
namespace MC_CAREER
{
	...
	static int mcCareer_GetHookmanCharacterSet(std::string p0) { return invoke<int>(0x46F1F010, p0); }
	...
	static int mcCareer_StartNewScript(std::string script, int stackSize) { return invoke<int>(0x3406912F, script, stackSize); }
	static int mcCareer_StartNewScript_SC(std::string script, int stackSize) { return invoke<int>(0xBB7BD7DE, script, stackSize); }
	...
	static int mcCareer_LoadPinkSlipProfile(short p0, std::string p1, int p2) { return invoke<int>(0x98B74626, p0, p1, p2); }
...
{
	static int mcMissionManager_GetMission(std::string mission) { return invoke<int>(0x8749413D, mission); }
...
{
	static int mcHookman_SetMission(int p0, std::string p1) { return invoke<int>(0x18637AE4, p0, p1); }
	...
	static void mcHookman_SetName(int p0, std::string p1) { invoke<Void>(0xA52805D1, p0, p1); }
	static std::string mcHookman_GetName(int p0) { return invoke<std::string>(0xFE3A6533, p0); }
	...
	static void mcHookman_SetCarConfigName(int p0, std::string p1) { invoke<Void>(0x918C1ED8, p0, p1); }
	static std::string mcHookman_GetCarConfigName(int p0) { return invoke<std::string>(0x0F2BA242, p0); }
	...
	static std::string mcHookman_GetCoreScriptName(int p0) { return invoke<std::string>(0x5A781F71, p0); }
...
namespace MC_SLOT_SYSTEM
{
	...
	static int mcSlotSystem_RequestSlot(int p0, std::string p1, int p2, int p3, std::string p4, int p5, BOOL p6, std::string p7) { return invoke<int>(0x7B6080CC, p0, p1, p2, p3, p4, p5, p6, p7); }
...
namespace MC_EXPERIENCE_MANAGER
{
	...
	static int mcExperienceManager_LookupSystemByName(std::string p0) { return invoke<int>(0x540B8DB4, p0); }
	static int mcExperienceManager_LookupLabelSystemByName(std::string p0) { return invoke<int>(0xB1186EFE, p0); }
...
namespace VHSM_STATE
{
	...
	static void vhsmState_SetText(int p0, std::string p1) { invoke<Void>(0xFFFBA7CB, p0, p1); }
	static void vhsmState_SetDataString(int p0, std::string p1) { invoke<Void>(0x53B76E50, p0, p1); }
...
namespace MC_CAR_ARRAY
{
	...
	static std::string mcCarArrayData_GetName(int p0) { return invoke<std::string>(0xEAA4B56C, p0); }
...
namespace MC_CONFIG
{
	...
	static std::string mcCharacterConfigData_GetName(int p0) { return invoke<std::string>(0xB0CA5B76, p0); }
	static std::string mcConfigData_GetName(int p0) { return invoke<std::string>(0x646B1F45, p0); }
	...
	static std::string mcCarConfig_GetVehicleTypeName(int p0) { return invoke<std::string>(0x2B55BE3D, p0); }
	static std::string mcCarConfig_GetVehicleProfileName(int p0) { return invoke<std::string>(0x15907902, p0); }
}
...
{
	static int StatsManager_GetIntValue(std::string p0, int p1) { return invoke<int>(0x7D123878, p0, p1); }
	...
	static void StatsManager_UpdateStatInt(std::string p0, int p1, int p2, int p3) { invoke<Void>(0xFCAF1F84, p0, p1, p2, p3); }
...
{
	static BOOL mcCareerSpeech_PlayScenario(int p0, std::string p1, std::string p2) { return invoke<BOOL>(0x7FEAC093, p0, p1, p2); }
	...
	static int mcCareerSpeech_FindScenario(std::string p0) { return invoke<int>(0xE85AF6EE, p0); }
